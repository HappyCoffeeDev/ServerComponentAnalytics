...
from ServerComponentAnalytics import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "ServerComponentAnalytics"
...
html_title = f"ServerComponentAnalytics v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/HappyCoffeeDev/ServerComponentAnalytics",
            "html": """
